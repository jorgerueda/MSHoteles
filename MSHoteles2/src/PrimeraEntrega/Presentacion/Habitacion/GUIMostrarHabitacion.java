...
public class GUIMostrarHabitacion extends javax.swing.JFrame implements Vista {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIMostrarHabitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	...
	public void actualizar(int id_evento_vista, Object datos) {
		//Borra lo anterior
         ...
         if(id_evento_vista == EventoVista.MOSTRAR_HABITACION_EXITO){
 			...
 			JOptionPane.showMessageDialog(null, "ERROR!! No se ha encontrado la habitacoin que se desea mostrar", "Mostrar Habitacion", JOptionPane.ERROR_MESSAGE);
 		}
